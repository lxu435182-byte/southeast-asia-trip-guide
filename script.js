...
const angkorGuide = [
  ...
  },
  {
    title: "推荐总路线",
    rows: [
      ["8.7 暹粒恢复日", "早到后酒店寄存、Wat Bo 寺/河边/老市场轻松逛；下午空邦鲁浮村 Kampong Phluk 洞里萨湖日落"],
  ...
  },
  {
    ...
    rows: [
      ...
      ["8.7 洞里萨湖半日团/包车", "建议酒店订空邦鲁浮村日落团 Kampong Phluk sunset tour，确认酒店接送、船票和等日落"],
  ...
  },
  {
    ...
    rows: [
      ...
      ["第二优先", "空邦鲁浮村 Kampong Phluk 洞里萨湖日落、龙蟠水池、塔逊寺、比粒寺"],
      ["可删项目", "班黛喀蒂、班提色玛、东梅奔"],
...
const luangPrabangGuide = [
  {
    title: "核心策略",
    rows: [
      ["住宿位置", "尼拉辛别墅 Villa Nirasim 在湄公河路 Khem Kong Road，靠近湄公河、夜市和寺庙区，适合省交通费"],
  ...
  },
  {
    ...
    rows: [
      ...
      ["方式", "机场打车/拼车去尼拉辛别墅 Villa Nirasim；官方旅游站写机场有到酒店/城区的定价出租车柜台"],
...
const itinerary = [
  {
    ...
    events: [
      ...
      { time: "07:00-09:30", text: "从金边德崇机场 KTI 进城到河边区 Riverside / 金边夜市 Night Market / 夜巴点附近，先寄存行李" },
      { time: "09:30-13:30", text: "早餐、放空、强制休息；优先找咖啡馆、酒店寄存或 day-use" },
      { time: "14:00-15:30", text: "金边王宫 Royal Palace + 银塔寺 Silver Pagoda，下午开放时段更顺" },
      { time: "15:30-16:45", text: "柬埔寨国家博物馆 National Museum，可帮助理解后面吴哥文物" },
      { time: "17:00-18:00", text: "塔山寺 Wat Phnom 或河边坐着休息；如果困到不行就直接删" },
      { time: "18:00-20:00", text: "金边夜市 Night Market / 河边区 Riverside 晚餐，买水、湿巾、零食，提前确认夜巴上车点" },
    ...
    panels: [
      {
        ...
        links: [
          mapLink("广州白云机场 T3（Guangzhou Baiyun T3）", "Guangzhou Baiyun International Airport Terminal 3"),
          mapLink("金边德崇机场 KTI（Techo International Airport）", "Techo International Airport Phnom Penh"),
          mapLink("金边河边区（Phnom Penh Riverside）", "Phnom Penh Riverside"),
          mapLink("金边夜市（Phnom Penh Night Market）", "Phnom Penh Night Market"),
          mapLink("金边王宫（Royal Palace Phnom Penh）", "Royal Palace Phnom Penh"),
          mapLink("银塔寺（Silver Pagoda）", "Silver Pagoda Phnom Penh"),
          mapLink("柬埔寨国家博物馆（National Museum of Cambodia）", "National Museum of Cambodia Phnom Penh"),
          mapLink("塔山寺（Wat Phnom）", "Wat Phnom Phnom Penh"),
          mapLink("夜巴上车点 France St.47（金边）", "Phnom Penh France St.47"),
        ],
      },
      {
        title: "航班信息",
      ...
      },
      {
        title: "金边低体力半日路线",
        items: [
          "当天按“低体力、高价值、靠近夜巴点”执行：金边德崇机场 KTI → 金边夜市 Night Market / 夜巴点寄存行李 → 早餐休息 → 14:00 王宫银塔寺 → 国家博物馆 → 河边 / 塔山寺 Wat Phnom → 晚餐 → 夜巴。",
          ...
          "塔山寺 Wat Phnom 离金边夜市 Night Market / 河边一带近，适合低体力收尾；困到不行就删掉，直接河边坐着。",
        ],
        links: [
      ...
      },
      {
        ...
        items: [
          ...
          "18:00-20:00 在金边夜市 Night Market / 河边区 Riverside 附近吃晚饭，买水、湿巾、面包/零食；提前 45-60 分钟到 France St.47 上车点确认座位、行李牌和上车位置。",
  ...
  },
  {
    ...
    open: true,
    events: [
      { time: "清晨", text: "抵达暹粒 Chong Kaosou Village，下车后打 Grab / PassApp / tuk-tuk 去吴哥印度支那酒店 Home Indochine d'Angkor" },
      { time: "06:30-09:30", text: "到吴哥印度支那酒店 Home Indochine d'Angkor 寄存行李，早餐、洗漱、补觉，问 early check-in" },
      { time: "10:00-11:30", text: "Wat Bo / 暹粒河边 / Old Market 老市场轻松逛" },
      { time: "11:30-14:00", text: "午饭 + 酒店午休，换衣服，带雨具、防蚊和防水袋" },
      { time: "14:00", text: "酒店出发去空邦鲁浮村 Kampong Phluk 码头，建议包车或酒店半日团" },
    ...
    panels: [
      {
        ...
        links: [
          mapLink("夜巴下车点 Chong Kaosou Village（暹粒）", "Siem Reap Chong Kaosou Village"),
          mapLink("吴哥印度支那酒店（Home Indochine d'Angkor）", "Home Indochine d'Angkor Siem Reap"),
          mapLink("Wat Bo 寺（Wat Bo）", "Wat Bo Siem Reap"),
          mapLink("暹粒河边（Siem Reap Riverside）", "Siem Reap Riverside"),
          mapLink("老市场（Old Market）", "Old Market Siem Reap"),
          mapLink("酒吧街（Pub Street）", "Pub Street Siem Reap"),
          mapLink("空邦鲁浮村（Kampong Phluk）", "Kampong Phluk Cambodia"),
        ],
      },
      {
        title: "当天策略",
      ...
      },
      {
        title: "洞里萨湖交通",
        items: [
          "建议选择空邦鲁浮村 Kampong Phluk，比 Chong Kneas 更有高脚屋、浮村和雨季水面感。",
          "酒店到码头车程约 45-60 分钟，雨季返程天黑，优先包车或让酒店订空邦鲁浮村日落团 Kampong Phluk sunset tour。",
      ...
      },
      {
        title: "酒店入住提醒",
        items: [
          "吴哥印度支那酒店 Home Indochine d'Angkor Hotel：Street 27 / Street27, Wat Bo Village, Siem Reap, Cambodia。",
    ...
    panels: [
      {
        ...
        links: [
          mapLink("吴哥印度支那酒店（Home Indochine d'Angkor）", "Home Indochine d'Angkor Siem Reap"),
          mapLink("吴哥寺（Angkor Wat）", "Angkor Wat"),
          mapLink("通王城南门（Angkor Thom South Gate）", "Angkor Thom South Gate"),
          mapLink("巴戎寺（Bayon）", "Bayon Temple Cambodia"),
          mapLink("斗象台（Terrace of the Elephants）", "Terrace of the Elephants Angkor"),
          mapLink("癞王台（Terrace of the Leper King）", "Terrace of the Leper King"),
          mapLink("塔布茏（Ta Prohm）", "Ta Prohm Temple"),
          mapLink("班黛喀蒂（Banteay Kdei）", "Banteay Kdei"),
          mapLink("皇家浴池（Srah Srang）", "Srah Srang"),
        ],
      },
      {
        title: "当天策略",
    ...
    panels: [
      {
        ...
        links: [
          mapLink("吴哥印度支那酒店（Home Indochine d'Angkor）", "Home Indochine d'Angkor Siem Reap"),
          mapLink("女王宫（Banteay Srei）", "Banteay Srei"),
          mapLink("班提色玛（Banteay Samre）", "Banteay Samre"),
          mapLink("圣剑寺（Preah Khan）", "Preah Khan Temple"),
          mapLink("龙蟠水池（Neak Pean）", "Neak Pean"),
        ],
      },
      {
        title: "当天策略",
  ...
  },
  {
    ...
    events: [
      ...
      { time: "晚", text: "入住 3Howw 素坤逸 21 青旅 3 Howw Hostel at Sukhumvit 21" },
    ],
    panels: [
      {
        title: "地点地图",
        ...
        links: [
          mapLink("吴哥印度支那酒店（Home Indochine d'Angkor）", "Home Indochine d'Angkor Siem Reap"),
          mapLink("塔逊（Ta Som）", "Ta Som Temple"),
          mapLink("东梅奔（East Mebon）", "East Mebon"),
          mapLink("比粒寺（Pre Rup）", "Pre Rup"),
          mapLink("暹粒吴哥国际机场 SAI（Siem Reap Angkor International Airport）", "Siem Reap Angkor International Airport"),
          mapLink("曼谷廊曼机场 T1（Don Mueang T1）", "Don Mueang International Airport Terminal 1"),
          mapLink("3Howw 素坤逸 21 青旅（3Howw Hostel Sukhumvit 21）", "3Howw Hostel at Sukhumvit 21 Bangkok"),
        ],
      },
      {
        title: "离开日策略",
      ...
      },
      {
        title: "曼谷酒店入住提醒",
        items: [
          "3Howw 素坤逸 21 青旅 3Howw Hostel @ Sukhumvit 21：32/9 Sukhumvit 21 Rd, Khlong Toei Nuea, Watthana, Bangkok 10110, Thailand。",
  ...
  },
  {
    ...
    label: "大城遗址",
    events: [
      { time: "早", text: "曼谷，3Howw 素坤逸 21 青旅 3 Howw Hostel at Sukhumvit 21" },
      { time: "白天", text: "曼谷出发游览大城遗址" },
      { time: "晚", text: "返回曼谷 3Howw 素坤逸 21 青旅 3 Howw Hostel at Sukhumvit 21" },
    ],
    panels: [
      {
        title: "地点地图",
        ...
        links: [
          mapLink("3Howw 素坤逸 21 青旅（3Howw Hostel Sukhumvit 21）", "3Howw Hostel at Sukhumvit 21 Bangkok"),
          mapLink("大城历史公园（Ayutthaya Historical Park）", "Ayutthaya Historical Park"),
          mapLink("玛哈泰寺（Wat Mahathat Ayutthaya）", "Wat Mahathat Ayutthaya"),
          mapLink("帕席桑碧寺（Wat Phra Si Sanphet）", "Wat Phra Si Sanphet"),
        ],
      },
      {
        title: "当天提醒",
  ...
  },
  {
    ...
    events: [
      ...
      { time: "15:30-16:30", text: "机场打车/拼车去尼拉辛别墅 Villa Nirasim，入住或寄存行李" },
      { time: "17:00-22:00", text: "逛西萨旺冯路 Sisavangvong Road 一带夜市，轻松吃第一顿老挝晚餐" },
      { time: "晚", text: "沿湄公河路 Khem Kong Road 河边散步，早点休息，第二天早起看托钵" },
    ],
    panels: [
      {
        title: "地点地图",
        ...
        links: [
          mapLink("3Howw 素坤逸 21 青旅（3Howw Hostel Sukhumvit 21）", "3Howw Hostel at Sukhumvit 21 Bangkok"),
          mapLink("曼谷廊曼机场 T1（Don Mueang T1）", "Don Mueang International Airport Terminal 1"),
          mapLink("琅勃拉邦机场（Luang Prabang International Airport）", "Luang Prabang International Airport"),
          mapLink("尼拉辛别墅（Villa Nirasim）", "Villa Nirasim Luang Prabang"),
          mapLink("琅勃拉邦夜市/西萨旺冯路（Sisavangvong Road Night Market）", "Luang Prabang Night Market Sisavangvong Road"),
          mapLink("湄公河路（Khem Kong Road）", "Khem Kong Road Luang Prabang"),
        ],
      },
      {
        title: "航班信息",
      ...
      },
      {
        ...
        items: [
          ...
          "住宿填尼拉辛别墅 Villa Nirasim，下一目的地填 China / Guangzhou，返程日期 8.15。",
        ],
      ...
      },
      {
        title: "琅勃拉邦酒店入住提醒",
        items: [
          "尼拉辛别墅 Nirasim Villa / Villa Nirasim：Khem Kong Road, 06000 Luang Prabang, Laos；当地名：ເຮືອນພັກ ນີລະສິມ。",
      ...
      },
      {
        title: "机场到酒店交通",
        items: [
          "琅勃拉邦机场到城区约 15-25 分钟，直接在机场打车/拼车去尼拉辛别墅 Villa Nirasim。",
      ...
      },
      {
        title: "抵达夜市慢逛",
        items: [
          "官方信息：琅勃拉邦夜市每天约 17:00 到 22:00，在西萨旺冯路 Sisavangvong Road 一带。",
  ...
  },
  {
    ...
    events: [
      ...
      { time: "晚", text: "夜市或湄公河边餐馆，住宿尼拉辛别墅 Villa Nirasim" },
    ],
    panels: [
      {
        title: "地点地图",
        ...
        links: [
          mapLink("尼拉辛别墅（Villa Nirasim）", "Villa Nirasim Luang Prabang"),
          mapLink("早市（Talad Sao）", "Talad Sao Luang Prabang morning market"),
          mapLink("香通寺（Wat Xieng Thong）", "Wat Xieng Thong"),
          mapLink("普西山（Mount Phousi）", "Mount Phousi Luang Prabang"),
          mapLink("琅勃拉邦夜市（Luang Prabang Night Market）", "Luang Prabang Night Market"),
          mapLink("湄公河河边（Mekong Riverfront）", "Mekong Riverfront Luang Prabang"),
        ],
      },
      {
        title: "托钵礼仪",
  ...
  },
  {
    ...
    events: [
      ...
      { time: "16:00-17:30", text: "去未爆弹游客中心 UXO Visitor Centre；若赶不上，改 TAEC 民族艺术中心" },
      { time: "18:30", text: "可选 Phralak Phralam 老挝传统舞蹈；预算紧则夜市和河边散步" },
      { time: "晚", text: "住宿尼拉辛别墅 Villa Nirasim" },
    ],
    panels: [
      {
        title: "地点地图",
        ...
        links: [
          mapLink("尼拉辛别墅（Villa Nirasim）", "Villa Nirasim Luang Prabang"),
          mapLink("关西瀑布（Kuang Si Waterfall）", "Kuang Si Waterfall"),
          mapLink("关西瀑布熊救助中心（Tat Kuang Si Bear Rescue Centre）", "Tat Kuang Si Bear Rescue Centre"),
          mapLink("未爆弹游客中心（UXO Visitor Centre）", "UXO Visitor Centre Luang Prabang"),
          mapLink("民族艺术中心（TAEC）", "Traditional Arts and Ethnology Centre Luang Prabang"),
          mapLink("老挝传统舞剧场（Royal Ballet Theatre / Phralak Phralam）", "Phralak Phralam Theatre Luang Prabang"),
        ],
      },
      {
        title: "关西瀑布交通与门票",
      ...
      },
      {
        title: "下午文化选择",
        items: [
          "未爆弹游客中心 UXO Visitor Centre 免费入场、鼓励捐赠，开放时间以现场为准；它能帮助理解老挝战争遗留问题。",
    ...
    panels: [
      {
        ...
        links: [
          mapLink("尼拉辛别墅（Villa Nirasim）", "Villa Nirasim Luang Prabang"),
          mapLink("琅勃拉邦机场（Luang Prabang International Airport）", "Luang Prabang International Airport"),
          mapLink("昆明长水机场（Kunming Changshui International Airport）", "Kunming Changshui International Airport"),
          mapLink("广州白云机场 T3（Guangzhou Baiyun International Airport T3）", "Guangzhou Baiyun International Airport Terminal 3"),
          mapLink("早市（Talad Sao）", "Talad Sao Luang Prabang morning market"),
          mapLink("湄公河河边（Mekong Riverfront）", "Mekong Riverfront Luang Prabang"),
        ],
      },
...
const transit = [
  ...
  },
  {
    ...
    links: [
      mapLink("上车点 France St.47（金边）", "Phnom Penh France St.47"),
      mapLink("下车点 Chong Kaosou Village（暹粒）", "Siem Reap Chong Kaosou Village"),
      mapLink("吴哥印度支那酒店（Home Indochine d'Angkor）", "Home Indochine d'Angkor Siem Reap"),
    ],
  },
  {
    ...
    links: [
      mapLink("暹粒吴哥机场 SAI（Siem Reap Angkor Airport）", "Siem Reap Angkor International Airport"),
      mapLink("曼谷廊曼机场 T1（DMK Don Mueang）", "Don Mueang International Airport Terminal 1"),
      mapLink("3Howw 素坤逸 21 青旅（3Howw Hostel Sukhumvit 21）", "3Howw Hostel at Sukhumvit 21 Bangkok"),
    ],
  },
  {
    ...
    links: [
      mapLink("曼谷廊曼机场 T1（DMK Don Mueang）", "Don Mueang International Airport Terminal 1"),
      mapLink("琅勃拉邦机场（Luang Prabang Airport）", "Luang Prabang International Airport"),
      mapLink("尼拉辛别墅（Villa Nirasim）", "Villa Nirasim Luang Prabang"),
    ],
  },
  {
    ...
    links: [
      mapLink("琅勃拉邦机场（Luang Prabang Airport）", "Luang Prabang International Airport"),
      mapLink("昆明长水机场（Kunming Changshui Airport）", "Kunming Changshui International Airport"),
      mapLink("广州白云机场 T3（Guangzhou Baiyun T3）", "Guangzhou Baiyun International Airport Terminal 3"),
    ],
  },
];
...
const stays = [
  {
    title: "吴哥印度支那酒店 Home Indochine d'Angkor Hotel",
    ...
    details: [
      ...
      "距酒吧街 Pub Street / 老市场 Old Market / 吴哥夜市 Angkor Night Market 约 1 km，去吴哥窟约 8.2 km；暹粒吴哥国际机场约 45 km，车程约 54-60 分钟。",
    ],
    links: [
      mapLink("Google Maps：吴哥印度支那酒店", "Home Indochine d'Angkor Siem Reap"),
  ...
  },
  {
    ...
    links: [
      mapLink("Google Maps：3Howw 素坤逸 21 青旅", "3Howw Hostel at Sukhumvit 21 Bangkok"),
      { label: "Booking", url: sources.howwBooking },
      { label: "Trip.com", url: sources.howwTrip },
    ],
  },
  {
    title: "尼拉辛别墅 Nirasim Villa / Villa Nirasim",
    meta: ["琅勃拉邦", "8.12 晚 - 8.15 早", "3 晚"],
    details: [
      "地址：湄公河路 Khem Kong Road, 06000 Luang Prabang, Laos；当地名：ເຮືອນພັກ ນີລະສິມ。",
      "电话：+856 20 2969 5277；邮箱：nirasimvilla@gmail.com。",
    ...
    links: [
      mapLink("Google Maps：尼拉辛别墅 Villa Nirasim", "Villa Nirasim Luang Prabang"),
      { label: "Booking", url: sources.nirasimBooking },
      { label: "Trip.com", url: sources.nirasimTrip },
    ],
  },
