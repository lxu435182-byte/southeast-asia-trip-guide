...
const angkorGuide = [
  {
    ...
    rows: [
      ...
      ["核心策略", "8.7 夜巴后轻量女王宫线，8.8 主线精华，8.9 大圈精选，8.10 睡饱吃好从容去机场"],
      ["执行原则", "每天只抓 3-5 个重点寺庙，按区域走不折返，中午留 2-3 小时吃饭/午睡，雨季把重点放上午"],
  ...
  },
  {
    title: "推荐总路线",
    rows: [
      ["8.7 Day 1", "夜巴抵达后休整，下午女王宫 + 班提色玛；轻量开启三日票"],
      ["8.8 Day 2", "吴哥寺日出 + 吴哥通王城 + 塔布茏；全程最重要的核心精华日"],
      ["8.9 Day 3", "圣剑寺 + 龙蟠水池 + 塔逊 + 东梅奔/比粒寺；更安静、更有遗址感"],
      ["8.10 离开日", "不再用票赶景点，睡醒吃饭，老市场/河边/咖啡馆轻松逛，13:30 左右去机场"],
    ],
    links: [],
  },
  {
    ...
    rows: [
      ...
      ["8.7 女王宫线 tuk-tuk", "约 US$30-35/车（约¥204-238/车）"],
      ["8.8 小圈日出 tuk-tuk", "约 US$20-25/车（约¥136-170/车）"],
      ["8.9 大圈 tuk-tuk", "约 US$20-25/车（约¥136-170/车）"],
      ["三天 tuk-tuk 合计", "约 US$70-85/车（约¥476-578/车），3-4 人分摊很划算"],
      ["机场巴士", "US$8/人（约¥54/人）"],
  ...
  },
  {
    ...
    rows: [
      ...
      ["第二优先", "龙蟠水池、塔逊寺、比粒寺"],
      ["可删项目", "班黛喀蒂、东梅奔、班提色玛"],
      ["不建议加入", "崩密列、荔枝山、洞里萨湖、一天双日出；会明显超负荷"],
    ],
    links: [],
  },
  {
...
const itinerary = [
  ...
  },
  {
    ...
    weekday: "周五",
    city: "暹粒",
    label: "吴哥 Day 1 · 轻量女王宫线",
    open: true,
    events: [
      { time: "05:58", text: "抵达暹粒 Larryta 夜巴终点" },
      { time: "06:30-07:00", text: "去 Home Indochine d'Angkor，寄存行李" },
      { time: "07:00-10:30", text: "早餐、洗漱、补觉；尽量问酒店 early check-in" },
      { time: "10:30-12:00", text: "买/确认吴哥三日票，联系 tuk-tuk 司机" },
      { time: "12:00-13:00", text: "午饭" },
      { time: "13:00-14:00", text: "回酒店休息或办理入住" },
      { time: "14:00-15:00", text: "出发女王宫" },
      { time: "15:00-16:15", text: "Banteay Srei 女王宫：吴哥雕刻精华，体力消耗低" },
      { time: "16:45-17:30", text: "Banteay Samre 班提色玛：人少、完整、安静" },
      { time: "18:15", text: "回酒店吃饭休息，入住 Home Indochine d'Angkor" },
    ],
    panels: [
      {
        title: "当天策略",
        items: [
          "这天是三日票第 1 天：不看日出，也不塞小圈，重点是夜巴后恢复体力。",
          "女王宫线属于路上坐车多、步行少、文化密度高的路线，适合第一次进入吴哥节奏。",
          "如果 early check-in 不成功，至少在酒店公共区休整、洗漱、充电，再出发。",
        ],
        links: [],
      },
      {
        title: "票务与司机",
        items: [
          "吴哥三日票官方价 US$62（约¥422），7 天内任选 3 天使用；优先官网/官方 App 购票。",
          "8.7 女王宫线 tuk-tuk 参考 US$30-35/车（约¥204-238/车）。",
          "提前说清楚路线、出发时间、酒店接送、是否等午休、是否提供冷水、最终总价。",
        ],
        links: [
          { label: "吴哥票种与价格", url: sources.angkorTickets },
          { label: "官方购票入口", url: sources.angkorTicketPortal },
          { label: "tuk-tuk 价格参考", url: sources.leeTukTuk },
        ],
      },
      {
        title: "酒店入住提醒",
    ...
    panels: [
      {
        title: "当天策略",
        items: [
          "这天是全程最重要的一天，但已经降强度：真正必须保留的是吴哥寺、巴戎寺、塔布茏寺。",
  ...
  },
  {
    ...
    open: true,
    events: [
      { time: "07:30", text: "酒店出发，不再强行早起" },
      { time: "08:00-09:30", text: "Preah Khan 圣剑寺：大圈最值得细看的寺" },
      { time: "09:50-10:25", text: "Neak Pean 龙蟠水池：雨季水景更好" },
      { time: "10:45-11:25", text: "Ta Som 塔逊寺：树门、小而精" },
      { time: "11:45-12:20", text: "East Mebon 东梅奔：砖石结构、象雕" },
      { time: "12:30-15:30", text: "午餐 + 回酒店午休" },
      { time: "16:00-17:15", text: "Pre Rup 比粒寺：天气好看夕阳；累了就取消" },
      { time: "18:00", text: "回酒店，继续住 Home Indochine d'Angkor" },
    ],
    panels: [
      {
        title: "当天策略",
        items: [
          "这天看更安静、更有遗址感的大圈，不再强行早起，给前两天留恢复空间。",
          "核心是圣剑寺、龙蟠水池、塔逊；东梅奔和比粒寺按体力与天气决定。",
          "不要再加崩密列、荔枝山或洞里萨湖，会明显超负荷。",
        ],
        links: [],
      },
      {
        title: "司机与删减",
        items: [
          "8.9 大圈 tuk-tuk 参考 US$20-25/车（约¥136-170/车）。",
          "如果 3-4 人同行，三天都包同一个 tuk-tuk 司机最省心。",
          "累了优先保留圣剑寺、龙蟠水池、塔逊；可删东梅奔、比粒寺或班提色玛。",
        ],
  ...
  },
  {
    ...
    open: true,
    events: [
      { time: "08:30-10:00", text: "睡醒、早餐、整理行李" },
      { time: "10:00-12:00", text: "老市场/河边/咖啡馆轻松逛" },
      { time: "12:00-13:00", text: "午餐" },
      { time: "13:00-13:20", text: "回酒店取行李" },
      { time: "13:30 左右", text: "出发去暹粒吴哥国际机场 SAI" },
    ...
    panels: [
      {
        title: "离开日策略",
        items: [
          "这天不要再用吴哥票赶景点，三日票已经在 8.7-8.9 完整用完。",
          "睡饱、吃好、轻松逛市区，给国际航班和新机场路程留缓冲。",
          "暹粒新机场 SAI 离市区远，别按老机场距离预估；建议 13:30 左右离开市区。",
        ],
        links: [],
      },
      {
